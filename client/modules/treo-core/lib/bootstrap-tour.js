...
(function(window, factory) {
    ...
    Tour = (function() {
        ...
        Tour.prototype.next = function(reflexForce) {
            var promise;
            promise = this.hideStep(this._current, this._current + 1);
            return this._callOnPromiseDone(promise, this._showNextStep, reflexForce);
        };
        ...
        Tour.prototype.showStep = function(i, reflexForce) {
            ...
            showStepHelper = (function(_this) {
                return function(e) {
                    if (_this._isOrphan(step)) {
                        if (step.orphan === false && !reflexForce) {
        ...
        Tour.prototype._showNextStep = function(reflexForce) {
            var promise, showNextStepHelper, step;
            step = this.getStep(this._current);
            showNextStepHelper = (function(_this) {
                return function(e) {
                    return _this.showStep(step.next, reflexForce);
                };
            })(this);
