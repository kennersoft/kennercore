...
Espo.define('treo-core:views/record/list', 'class-replace!treo-core:views/record/list', function (Dep) {
    ...
    return Dep.extend({
        ...
        actionQuickView: function (data, e, extOptions) {
            data = data || {};
            var id = data.id;
            if (!id) return;
            ...
            if (!this.quickDetailDisabled) {
                ...
                this.createView('modal', viewName, _.extend(options, extOptions), function (view) {
        ...
        actionQuickEdit: function (data, e, extOptions) {
            data = data || {};
            var id = data.id;
            if (!id) return;
            ...
            if (!this.quickEditDisabled) {
                ...
                this.getRouter().dispatch(scope, 'edit', _.extend(options, extOptions));
            }
        }
