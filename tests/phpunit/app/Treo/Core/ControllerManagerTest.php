...
class ControllerManagerTest extends TestCase
{
    ...
    /**
     * Test is process method exists
     */
    public function testIsProcessMethodExists()
    {
        $service = $this->createMockService(ControllerManager::class);

        // test
        $this->assertTrue(method_exists($service, 'process'));
    }
