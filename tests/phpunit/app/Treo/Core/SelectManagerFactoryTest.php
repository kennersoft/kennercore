...
/**
 * Class SelectManagerFactoryTest
 *
 * @author r.zablodskiy@zinitsolutions.com
 */
class SelectManagerFactoryTest extends TestCase
{
    /**
     * Test is create method exists
     */
    public function testIsCreateExists()
    {
        $service = $this->createMockService(SelectManagerFactory::class);
