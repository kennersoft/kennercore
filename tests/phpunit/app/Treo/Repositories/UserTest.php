...
{
    /**
     * Test is getAdminUsers method exists
     */
    public function testIsGetAdminUsers()
    {
        $service = $this->createMockService(User::class);

        // test
        $this->assertTrue(method_exists($service, 'getAdminUsers'));
    }
