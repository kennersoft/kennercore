...
{
    /**
     * Test is newVersionChecker return true
     */
    public function testIsNewVersionCheckerReturnTrue()
    {
        $service = $this->createMockService(AdminNotifications::class);

        // test 1
        $this->assertTrue($service->newVersionChecker([]));

        // test 2
        $this->assertTrue($service->newVersionChecker(['field' => 'value']));
    }
